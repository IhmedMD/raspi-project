...
EXPOSURE_AUTO = True        # True = exposition auto, False = manuel
EXPOSURE_TIME = 20000       # Temps d'exposition en µs (si EXPOSURE_AUTO = False)
GAIN_AUTO = True            # True = gain auto, False = manuel
GAIN = 5                    # Gain en dB (si GAIN_AUTO = False)
# =========================
